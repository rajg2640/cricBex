      ...
      <div className="xl:w-9/12 lg:w-8/12 w-full space-y-6 px-3">
          ...
          <Table>
            <TableBody className="[&_td]:p-3 [&_tr]:border-0 text-end text-sm leading-4">
              ...
              <TableRow>
                ...
                <TableCell
                  colSpan={4}
                  className="text-center text-dark-gray-700 border-l border-light-gray-600"
                >
                  FC CAREER
                </TableCell>
              </TableRow>
              ...
              <TableRow className="bg-light-gray text-dark-gray-700">
                ...
                <TableCell
                  colSpan={3}
                  className="border-l border-light-gray-600"
                >
                  This Bowler
                </TableCell>
                <TableCell>Mat</TableCell>
                <TableCell className="border-l border-light-gray-600">
                  Mat
                </TableCell>
        ...
        <div className="rounded-2xl bg-white shadow-sm">
          ...
          <div className="p-3 sm:pl-16 xxs:pl-10 pl-5 flex sm:gap-5 gap-3">
            ...
            <div className="text-dark-gray-800 leading-5 max-w-[380px]">
              ...
              <p className="text-[15px]">
                uses his feet and drives but can&apos;t get past the short extra
                cover.
              </p>
            </div>
          </div>
            ...
            <div key={i}>
              ...
              <div className="py-2.5 px-3 bg-primary-100 border-l-4 border-primary flex items-center justify-between">
                <div>
                  ...
                  <p className="text-dark-gray-50 mt-1 text-[13px] leading-3.5">
                    {over.runs} runs
                  </p>
                </div>
          ...
          <div className="p-4 pb-5 flex justify-center">
            <Button variant="link" className="text-[15px] leading-5font-bold">
              Read full commentary
            </Button>
          </div>
          <div className="p-3 bg-light-gray-800">
            <p className="uppercase text-xs leading-3.5 text-dark-gray-100">
              Commentary Feedback
            </p>
          </div>
          <div className="sm:py-4">
            <form className="sm:p-6 p-4">
              ...
              <Button className="rounded-full font-bold text-[15px] leading-5 mt-5">
                Submit Feedback
              </Button>
            </form>
          </div>
