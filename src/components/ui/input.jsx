...
function Input({
  ...
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "file:text-foreground placeholder:text-dark-gray-200 text-dark-gray-50 selection:bg-primary leading-none! py-2.5 px-4 text-[15px] selection:text-primary-foreground dark:bg-input/30 border-[#CBCCCE] w-full min-w-0 rounded-lg border bg-transparent text-base transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
